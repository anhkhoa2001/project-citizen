...
<body>
    ...
    <script>
        ...
        let chart2Dataset = [];
        <%
        Map<String, Integer> mapchart2 = (HashMap<String, Integer>) request.getAttribute("mapcountchart24");
        for (String i : mapchart2.keySet()) {%>
                chart2Label[chart2Label.length++] = '<%=i %>';
                chart2Dataset[chart2Dataset.length++] = <%=mapchart2.get(i) %>;
        <% } %>
